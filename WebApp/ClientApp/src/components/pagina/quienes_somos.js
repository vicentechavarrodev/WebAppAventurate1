                                    ...
                                    <Carousel>
                                        <Carousel.Item className="item" >
                                            <img
                                                ...
                                                src="https://imgbox.es/images/2020/09/19/Hoteles-todo-incluido908deaa532e73f06.jpg"
                                                alt="First slide"
                                            />
                                        </Carousel.Item>
                                        <Carousel.Item className="item" >
                                    ...
                                    <Row>
                                        <Col className="justify-content-center pr-0" sm={12} md={8} >
                                            <ListGroup className="list-group-flush  ">
                                                ...
                                                <ListGroupItem>
                                                    <div className="m-1  embed-responsive embed-responsive-16by9 ">
                                            ...
                                            <ListGroup variant="flush">
                                                ...
                                                <ListGroup.Item>
                                                    <Row className="justify-content-md-center ">
                                                        ...
                                                        <Col sm={12} md={10} ><a href="https://www.facebook.com/instagram/"> Coaventurate</a></Col>
                                                    </Row>
                                                </ListGroup.Item>
